...
export default function FencingIndexPage() {
  const fencing = homepageServiceCards.filter((s) =>
    ["wood", "vinyl", "ornamental", "chain-link", "commercial", "automated-gates"].includes(s.slug),
  );

  return (
    <section className="section-y">
      <div className="container-site">
        <h1 className="text-[40px] font-bold tracking-tight md:text-[56px]">Fencing</h1>
        <p className="mt-4 max-w-2xl text-[17px] text-muted md:text-[18px]">
          Choose the material, privacy level and style that works for your property. We&apos;ll help with layout, project planning and installation.
        </p>
        ...
        <ButtonLink href="/quote" className="mt-10">Get a Free Quote</ButtonLink>
      </div>
    </section>
  );
}
